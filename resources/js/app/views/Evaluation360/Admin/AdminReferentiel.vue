  ...
  <v-container fluid>
    ...
    >
      <div class="d-flex justify-start align-center mb-8">
        <h1 class="text-center">Liste des référentiels</h1>
    ...
    <v-dialog v-model="generalDialog" max-width="600" style="z-index: 2500">
      <v-card class="py-5">
        ...
        <div class="d-flex justify-center">
          ...
          >
            <v-text-field
              v-model="referentielName"
              :rules="referentielRules"
              label="Référentiel"
              required
            ></v-text-field>
          </v-form>
...
<script src="./js/adminReferentiel.js"></script>